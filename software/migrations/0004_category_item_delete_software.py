...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('software', '0003_remove_software_image_software_image_url'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='software.category')),
